...
def main_sub():
    ...
    possible_criteria_personal_information = [
        'dec',
        'attr',
        'sinc',
        'intel',
    ...
    match_X = match_X[possible_criteria_personal_information]

    # possible clusters 2,3,5
    number_clusters = 7

    # elbow method plot
    ma.plot_wcss(match_X, max_clusters=number_clusters, name='Personal Data')

    # get values of df
    X_val = match_X.values

    # clustering with kmeans++
    y_clust = ma.k_means_cluster(X_val, n_clusters=5)
    ...
    print('Personal Information Kmeans pairplot')
    ...
    sns_plot1.savefig("results/pairplotPersonal.png")
    plt.clf()  # Clean parirplot figure from sns

    print('Personal Information clustering is done!')
