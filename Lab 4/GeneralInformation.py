...
def main_sub():
    ...
    # General Information we want to have a closer look on
    possible_criteria_general_information = [
        'gender',
        'match',
        'samerace',
        'age_o',
    ...
    match_X = match_X[possible_criteria_general_information]
    # possible clusters 2, 5, 6
    number_cluster = 15

    # elbow method plot
    ma.plot_wcss(match_X, number_cluster, name='general Data')
    ...
    print('General Information Kmeans pairplot')
    ...
    sns_plot1.savefig("results/pairplotGeneral.png")
    plt.clf()  # Clean parirplot figure from sns

    print('General Information clustering is done!')
